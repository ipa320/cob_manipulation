...
def cob_lookat_action_client():
    ...
    client = actionlib.SimpleActionClient('cob_lookat', cob_lookat_action.msg.LookAtAction)
    ...
    fk_req.robot_state.joint_state.name = ["torso_lower_neck_tilt_joint","torso_pan_joint","torso_upper_neck_tilt_joint","lookat_back_joint","lookat_x_joint","lookat_y_joint","lookat_z_joint"]
    fk_req.robot_state.joint_state.position = [random.uniform(-0.25,0.25), random.uniform(-0.2,0.2), random.uniform(-0.4,0.4), random.uniform(0.3,5.0), random.uniform(-3.141,3.141), random.uniform(-3.141,3.141), random.uniform(-3.141,3.141)]
